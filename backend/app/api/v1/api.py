...
from app.api.v1.routers import auth, seniors, exercises, prayers, medicines, checkins, emergency, care_requests, media, caregivers, users
...
api_router.include_router(caregivers.router, prefix="/caregivers", tags=["Caregiver Management"])
